    ...
    <div className="space-y-7">
      ...
      <div className="flex flex-col items-center gap-4">
        <button
          ...
          disabled={uploading}
          className="relative w-36 h-36 rounded-full bg-[#F4F0FE] dark:bg-[#241d38] border-2 border-dashed border-[#D8D5E2] dark:border-[#3a3448] hover:border-[#A98BE8] dark:hover:border-[#6a4fb0] cursor-pointer transition-colors overflow-hidden group disabled:cursor-not-allowed"
        >
          {imageUrl ? (
            <>
            ...
            <div className="w-full h-full flex flex-col items-center justify-center text-[#9098A3] dark:text-content-subtle group-hover:text-[#5A2DD4] dark:group-hover:text-[#b9a4f7] gap-2 transition-colors">
        ...
        <p className="text-xs font-medium text-[#9098A3] dark:text-content-subtle">JPG, PNG or GIF · Max 5 MB</p>
