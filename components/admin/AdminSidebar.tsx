  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 bg-mainPurple text-white p-2 rounded-lg"
      >
              ...
              return (
                <li key={item.href}>
                  <Link
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                    className={`
                      flex items-center gap-3 px-4 py-3 rounded-lg font-spaceGrotesk transition-all
                      ${
                        isActive
