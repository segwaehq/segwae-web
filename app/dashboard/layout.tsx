        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200">
            <button
              ...
              disabled={loggingOut}
              className="w-full flex items-center gap-3 px-4 py-3 rounded-lg font-spaceGrotesk font-medium text-red-600 hover:bg-red-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
