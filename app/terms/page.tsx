    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-lg max-w-none font-openSans">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">Segwae is a professional networking platform that allows users to:</p>
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">You may not post content that:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted">
            ...
            <a href="/privacy-policy" className="text-mainPurple dark:text-[#b9a4f7] hover:underline">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">You may not:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">We may terminate or suspend your account at any time for:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">For questions about these Terms, contact us at:</p>
