...
export default async function ContactSettingsPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <p className="font-spaceGrotesk text-grey2 dark:text-content-muted mb-8">
        Configure WhatsApp and Instagram contact information for order placement.
      </p>

      <div className="bg-white dark:bg-surface-raised rounded-2xl p-8 shadow-lg">
      ...
      <div className="mt-8 bg-blue/5 border border-blue/20 rounded-xl p-6">
        ...
        <div className="space-y-2 font-openSans text-sm text-grey1 dark:text-content">
          <p>
            <strong>WhatsApp Number Format:</strong> Enter the number with country code, no spaces or special characters.
          </p>
          <p className="font-mono bg-white dark:bg-white/[0.06] px-3 py-2 rounded">
