...
interface Props {
  initialSubscribers: WaitlistSubscriber[]
}

export default function WaitlistClient({ initialSubscribers }: Props) {
  const [subscribers] = useState<WaitlistSubscriber[]>(initialSubscribers)
  const [filteredSubscribers, setFilteredSubscribers] =
    useState<WaitlistSubscriber[]>(initialSubscribers)
