        ...
        <div className="relative">
          ...
          <div className="px-6">
            ...
            {!profile.is_profile_complete && (
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 mb-4 rounded-full bg-warningYellow/10 border border-warningYellow/30">
                <svg
                  className="w-4 h-4 text-warningYellow"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
                ...
                <span className="text-xs font-medium text-warningYellow">
                  Profile incomplete
                </span>
              </div>
            )}
