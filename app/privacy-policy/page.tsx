...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <p className="font-openSans text-grey2 dark:text-content-muted mb-12">Last updated: {new Date().toLocaleDateString()}</p>
      ...
      <div className="prose prose-lg max-w-none font-openSans">
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">We use the collected information to:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">We do not sell your personal information. We may share your information with:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">You can control what information is visible on your public profile:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">We implement industry-standard security measures including:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">You have the right to:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">Our app uses:</p>
          <ul className="list-disc pl-6 text-grey2 dark:text-content-muted space-y-2">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted">
        ...
        <section className="mb-12">
          ...
          <p className="text-grey2 dark:text-content-muted mb-3">If you have questions about this Privacy Policy, please contact us at:</p>
          <ul className="list-none text-grey2 dark:text-content-muted space-y-2">
            <li>Email: privacy@segwae.com</li>
            <li>Website: <a href="/contact" className="text-mainPurple dark:text-[#b9a4f7] hover:underline">segwae.com/contact</a></li>
          </ul>
        </section>
      </div>
    </div>
